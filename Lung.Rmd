...
```{r}
# stratified by ecog
log_rank_sex_byecog <- survdiff(surv_object ~ sex + strata(ph_ecog), data = lung_cc, rho = 0)
print(log_rank_sex_byecog)

wilcoxon_sex_byecog <- survdiff(surv_object ~ sex + strata(ph_ecog), data = lung_cc, rho = 1)
print(wilcoxon_sex_byecog)
```
